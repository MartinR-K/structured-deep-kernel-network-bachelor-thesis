...
run_dir = os.path.join("results", DATA_NAME, "single_model", f"{DATA_NAME}_sdkn_{name}_{timestamp}")
...
plt.title(
    ...
    f"HPs: L={L}, M={M}, hidden dims={hidden_dims}, P={num_params}, batch size={batch_size}"
)
